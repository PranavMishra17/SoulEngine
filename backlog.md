...
| 5 | 16 | 8 | broker, eval harness, voice vending and streaming landed; the Unity client runs without provider keys. Text harness specced, not built |
| 6 | 8 | 0 | not started |
| **Total** | **78** | **46** | — |
