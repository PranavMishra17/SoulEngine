...
| 6 | 8 | 0 | not started |
| 7 | 16 | 7 | 7.1-7.4 and 7.13 landed 2026-09-12; baseline in `research/09-npc-runtime/BASELINE.md`; ERR-030 fixed and gated; 7.5 landed; default stays parallel — single loses actions (see BASELINE.md); 7.16 proposed |
| **Total** | **98** | **57** | — |
